        ...
        <div id="header" class="row m-0 p-4">
            ...
            <div id="menu__mobile" class="col-12 col-md-6 p-0" style="height: 40px;">
                <div  class="p-2" style="width: 55%;height: 40px;margin: auto;display: flex;">
                    ...
                    <p class="font-weight-bold" style="width: 25%;"><a href="/shoppet/phpChatBot/" style="text-decoration: none;color: black">Chat</a></p>
		    <p class="font-weight-bold" style="width: 25%;"><a href="/shoppet/AboutUs/Demo.html" style="text-decoration: none;color: black">About Us</a></p>
